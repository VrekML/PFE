...
- Engrenage animé
- Boite animé
- Texture animée de fumée
- Texture animée de convoyeur (animé en intégration)
- Tuyeau brisé qui tombe (pas l'animation en jeu)
- Certaines textures (modèle de map): chimney, cone, custom_pipe, finishLine, lm1, lm2, lm3, machine_lava, poubelle_bunch, road_+, road_t, road_turn, sac_poubelle, turnRight
